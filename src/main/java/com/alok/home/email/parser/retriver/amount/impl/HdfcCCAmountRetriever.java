...
public class HdfcCCAmountRetriever implements AmountRetriever {
    ...
    private static final Pattern PATTERN4 = Pattern.compile("Rs\\. ([0-9]{0,5}[,]{0,1}[0-9]{0,5}[,]{0,1}[0-9]{1,5}.[0-9]{0,2}) has been debited from your HDFC Bank Credit Card ending \\d+ towards ");
